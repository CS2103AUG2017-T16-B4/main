...
.  Data stored in addressbook should not be corrupted in event of unexpected error leading to application crashing unexpectedly.
...
.  App should be updated regularly for bug fixes or implementing a new feature.
