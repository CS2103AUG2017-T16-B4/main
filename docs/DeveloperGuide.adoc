...
4. AddressBook selects contact.
5. User requests to delete particular field(s).
6. AddressBook clears the listed field(s).
...
2.  AddressBook adds person in the specified format to the list.
3.  AddressBook acknowledges that the person has been added to the list.
+
Use case ends.
...
*Preconditions*
1. AddressBook contains existing contact with the name to be duplicated.
...
2. AddressBook shows list of existing contacts of same name.
3. AddressBook asks if user wants to continue, update existing contact, or end use case.
4. User requests to continue.
5. AddressBook creates new contact.

* 1a. User does not follow the specified format required for input.
* 1b. Person with same name is already in the list
Error: AddressBook informs user that input is invalid.
...
2.  AddressBook edits the contact particular and displays latest change
+
Use case ends.
...
*3c. AddressBook updates selected contact.
+
Use case ends.
+
**3b1. The given index is invalid.
+
***3b11. AddressBook shows an error message.
+
...
*Preconditions*
1. AddressBook is not empty.

*MSS*

1. User requests to clear list.
2. AddressBook clears list.
+
Use case ends.
...
2. AddressBook closes the program.
+
Use case ends.
...
2. AddressBook shows list of commands in reverse chronological order.
+
Use case ends.
* 1a. Person Index is invalid.
+
AddressBook informs user that Person Index is invalid.

* 1b. User requests to edit information in an invalid format
+
Addressbook informs user that the format is invalid, providing the correct format.
...
*MSS*
 ...
 2.  AddressBook finds contact with keyword included in name, and displays latest change
 +
 Use case ends.
...
+
AddressBook informs user that contact cannot be found
...
3.  AddressBook selects contact with index given.
...
+
AddressBook informs user that there are currently no contacts in the list.

* 2a. User inputs invalid contact index.
+
AddressBook informs user that the input is not a valid contact index.
...
.  Data held in addressbook cannot be corrupted in event of unexpected errors.
.  System should be usable by users who are new to entering commands via Command Line Interface (CLI).
.  Should work even after 100 entries of invalid commands.
...
.  App should be updated once a month for bug fixes or implementing a new feature.
...
....
User-interface (focuses on maximising usability and optimal user experience).
....
...
....
Graphical User Interface. Allows users to interact with the software using graphical and visual icons instead of text.
....
...
....
Separating a computer program into distinct section such that each section address and single and unique concern.
....
...
....
Behaviour that is specific to an individual.
....
